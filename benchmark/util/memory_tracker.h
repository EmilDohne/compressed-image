...
#include <mach/mach.h>
    ...
    struct memory_tracker
    {
        ...
        {
            return static_cast<double>(get_memory_used_by_current_process()) / 1024;
        }

        inline static double get_mb_used() noexcept
        {
            return static_cast<double>(get_memory_used_by_current_process()) / 1024 / 1024;
        }

        inline static double get_gb_used() noexcept
        {
            return static_cast<double>(get_memory_used_by_current_process()) / 1024 / 1024 / 1024;
        }
    };
} // bench_util
