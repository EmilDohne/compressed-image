...
NAMESPACE_COMPRESSED_IMAGE
{
    namespace cuda
    {
        ...
        {
            NAMESPACE_COMPRESSED_IMAGE::enums::codec codec() const noexcept override
            {
                return NAMESPACE_COMPRESSED_IMAGE::enums::codec::lz4_gpu;
            };

            compression_options default_compression_opts() const noexcept override
            {
            ...
            decompression_options default_decompression_opts() const noexcept override
            {
                return nvcompBatchedLZ4DecompressDefaultOpts;
            };

            size_t max_block_size() const noexcept override
            {
